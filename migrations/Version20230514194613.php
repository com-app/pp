 ...
 */
final class Version20230514194613 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, day DATE NOT NULL, total_ngn BIGINT NOT NULL, total_cfa BIGINT NOT NULL, rate NUMERIC(10, 0) NOT NULL, type SMALLINT NOT NULL, debit DOUBLE PRECISION NOT NULL, credit DOUBLE PRECISION NOT NULL, state TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_7D3656A47E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
